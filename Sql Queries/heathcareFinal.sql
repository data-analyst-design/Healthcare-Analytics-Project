...
--***** Add new col of age_group and change age_group of all Peaditric patients to 0-17 ******--
...
UPDATE healthcare
SET standardized_age_group = CASE WHEN department = 'Pediatrics' THEN '0-17'
						ELSE age_group END;
